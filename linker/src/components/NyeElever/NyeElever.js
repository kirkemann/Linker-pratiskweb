...
const NyeElever = () => {
    ...
    const [aktivite]= useState([
        ...
        //{aktiv: 'business-man-1385050_640.jpg', overskrift:'Ib Ibsen', producttext: 'Hold møde eller firmaevent i smukke, autentiske rammer med plads til kreativitet', link: 'Læs mere her', id: 5},
